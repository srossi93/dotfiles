# [Simone](https://github.com/srossi93)’s dotfiles [![Build Status](https://travis-ci.org/srossi93/dotfiles.svg?branch=master)](https://travis-ci.org/srossi93/dotfiles)
...
| OS | Snippet |
|:---|:---|
| `macOS` | `bash -c "$(curl -LsS https://raw.github.com/srossi93/dotfiles/master/src/os/setup.sh)"` |
| `Ubuntu` | `bash -c "$(wget -qO - https://raw.github.com/srossi93/dotfiles/master/src/os/setup.sh)"` |
